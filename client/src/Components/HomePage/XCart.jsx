                ...
                <div className='w-full'>
                    ...
                    <div className='mt-2'>
                        ...
                        <div className='py-5 flex flex-wrap justify-between items-center'>
                            ...
                            <div className={`${true ? 'text-green-600' : 'text-gray-600'} space-x-3 flex items-center`}>
                            ...
                            <div className={`${true ? 'text-pink-600' : 'text-gray-600'} space-x-3 flex items-center`}>
                               {true? <FavoriteIcon onClick={handleLikePost} className='cursor-pointer' />: <FavoriteOutlinedIcon onClick={handleLikePost} className='cursor-pointer'/>}
                                <p>100</p>
                            </div>
                            <div className='space-x-3 flex items-center text-gray-600'>
